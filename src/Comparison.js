...
function Comparison() {
  ...
  const handleWrongGuess = () => {
    ...
    setOptionalText(`Incorrect! ${fakeName} is a name generated by Medipram. It is not currently available on the market... But it could be! Buy the rights to ${fakeName}.`);
  }
  ...
  return (
    <div className="comparison orange-image">
      ...
      <p className="comparison-text">Let's see how Medipram's randomly generated names compare to current prescription drug names on the market.<br/>Below, one name is a <span className="real-product">real drug</span> and the other is a <span className="fake-product">name generated by Medipram</span>. Try to identify the <span className="real-product">real product</span>.</p>
